   ...
   <nav>
    <div class="nav-wrapper">
      ...
      <ul id="dropdown1" class="dropdown-content">
        <li><a href="index.php">Por Aprobar</a></li>
        <li class="divider"></li>
      ...
      <ul id="dropdown3" class="dropdown-content">
        <li><a href="http://concursos.beneficioslaaraucana.cl/verano2018/bases.php" target="_blank">Bases</a></li>
        <li class="divider"></li>
        <li><a href="http://concursos.beneficioslaaraucana.cl/verano2018/" target="_blank">Formulario</a></li>
        <li class="divider"></li>
      ...
      <ul class="side-nav" id="mobile-demo">
        ...
        <li class="bold"><a href="index.php" class="waves-effect waves-teal">&nbsp &nbsp   Por Aprobar  </a></li>
        <li class="bold"><a href="aprobadas.php" class="waves-effect waves-teal">&nbsp &nbsp Aprobadas</a></li>
        <li class="bold"><a href="rechazadas.php" class="waves-effect waves-teal">&nbsp &nbsp Rechazadas</a></li>
